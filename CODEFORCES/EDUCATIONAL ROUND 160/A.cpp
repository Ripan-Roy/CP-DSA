...
void helper()
{
    ...
    RFOR(i, n, 0)
    {
        string num1 = str.substr(0, i);
        string num2 = str.substr(i);

        if (num1 == "" or num1[0] == '0' or num2 == "" or num2[0] == '0')
        {
            continue;
        }
        ll val1 = stoi(str.substr(0, i));
        ll val2 = stoi(str.substr(i));
        if (val1 > 0 and val2 > 0 and val2 - val1 > 0)
        {
            cout << val1 << " " << val2 << endl;
            return;
        }
